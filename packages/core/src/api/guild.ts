...
export class GuildsAPI {
	 ...
	 */
	public async get(guildId: string, { signal }: Pick<RequestData, 'signal'> = {}): Promise<RESTGetAPIGuildResult> {
	 ...
	 */
	public async getWebhooks(id: Snowflake): Promise<RESTGetAPIGuildWebhooksResult> {
