import type { REST } from '@discord-selfbot-sdk/rest';
import { calculateShardId, GatewayRateLimitError } from '@discord-selfbot-sdk/util';
import { WebSocketShardEvents } from '@discord-selfbot-sdk/ws';
