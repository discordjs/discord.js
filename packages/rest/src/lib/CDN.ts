...
export class CDN {
	...
	/**
	 * Generates a URL for a server tag badge.
	 *
	 * @param guildId - The guild id
	 * @param badgeHash - The hash provided by Discord for this badge
	 * @param options - Optional options for the badge
	 */
	public serverTagBadge(guildId: string, badgeHash: string, options?: Readonly<BaseImageURLOptions>): string {
		return this.makeURL(`/clan-badges/${guildId}/${badgeHash}`, options);
	}
