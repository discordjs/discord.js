 ...
 * @remarks has substructures for the components contained in the section (e.g. `TextDisplayComponent`, `ButtonComponent`, ...) which need to be instantiated and stored by an extending class using it
 */
