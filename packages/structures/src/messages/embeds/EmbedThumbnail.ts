 ...
 */
export class EmbedThumbnail<Omitted extends keyof APIEmbedImage | '' = ''> extends Structure<APIEmbedImage, Omitted> {
	/**
	 * @param data - The raw data received from the API for the embed thumbnail
	 */
