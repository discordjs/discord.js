...
class GuildChannelManager extends CachedManager {
  ...
  async createWebhook({ channel, name, avatar, reason }) {
    ...
    if (!id) throw new TypeError(ErrorCodes.INVALID_TYPE, 'channel', 'GuildChannelResolvable');
  ...
  async edit(channel, data) {
    ...
    if (!channel) throw new TypeError(ErrorCodes.INVALID_TYPE, 'channel', 'GuildChannelResolvable');
  ...
  async fetch(id, { cache = true, force = false } = {}) {
    ...
    if (id) {
      ...
      if (this.guild.id !== data.guild_id) throw new Error(ErrorCodes.GUILD_CHANNEL_UNOWNED);
