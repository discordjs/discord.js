...
class MessageManager extends CachedManager {
  ...
  async edit(message, options) {
    ...
    if (!messageId) throw new TypeError(ErrorCodes.INVALID_TYPE, 'message', 'MessageResolvable');
  ...
  async crosspost(message) {
    ...
    if (!message) throw new TypeError(ErrorCodes.INVALID_TYPE, 'message', 'MessageResolvable');
  ...
  async react(message, emoji) {
    ...
    if (!emoji) throw new TypeError(ErrorCodes.EMOJI_TYPE, 'emoji', 'EmojiIdentifierResolvable');
