...
class GuildStickerManager extends CachedManager {
  ...
  async create({ file, name, tags, description, reason } = {}) {
    ...
    if (!resolvedFile) throw new TypeError(ErrorCodes.REQ_RESOURCE_TYPE);
  ...
  async edit(sticker, data = {}) {
    ...
    if (!stickerId) throw new TypeError(ErrorCodes.INVALID_TYPE, 'sticker', 'StickerResolvable');
  ...
  async delete(sticker, reason) {
    ...
    if (!sticker) throw new TypeError(ErrorCodes.INVALID_TYPE, 'sticker', 'StickerResolvable');
