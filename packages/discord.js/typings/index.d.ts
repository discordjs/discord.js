...
> extends ContextMenuCommandInteraction<Cached> {
  ...
  public options: Omit<CommandInteractionOptionResolver<Cached>, 'getFocused' | 'getMentionable' | 'getRole' | 'getNumber' | 'getInteger' | 'getString' | 'getChannel' | 'getBoolean' | 'getSubcommandGroup' | 'getSubcommand' | 'getMessage' | 'getAttachment'>;
