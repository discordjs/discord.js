...
client.on('ready', () => {
  ...
  expectType<LinkButtonOptions>(validHTTPLinkButtonOptions);
  ...
  expectType<LinkButtonOptions>(validHTTPSLinkButtonOptions);
  ...
  expectType<LinkButtonOptions>(validDiscordLinkButtonOptions);
});
