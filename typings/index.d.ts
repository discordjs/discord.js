...
export class CommandInteractionOptionResolver {
  ...
  public getBoolean<T extends boolean | undefined>(name: string, required?: boolean, defaultValue?: T): T extends boolean ? boolean : null;
  ...
  public getString<T extends string | undefined>(name: string, required?: boolean, defaultValue?: T): T extends string ? string : null;
  public getInteger(name: string, required: true): number;
  public getInteger<T extends number | undefined>(name: string, required?: boolean, defaultValue?: T): T extends number ? number : null;
  public getNumber(name: string, required: true): number;
  public getNumber<T extends number | undefined>(name: string, required?: boolean, defaultValue?: T): T extends number ? number : null;
