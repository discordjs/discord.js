...
This intent is required to receive direct messages. In discord.js however, you **must** specify partials as well. See the [partials](https://media.discordapp.net/attachments/999796393810067607/1161040112663138414/image.png) topic on how this is done.
