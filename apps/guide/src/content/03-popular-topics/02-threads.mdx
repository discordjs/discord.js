...
<Alert title="Tip" type="info">
	You can use the <DocsLink type="class" parent="ThreadChannel" symbol="isThread" brackets /> type guard to make sure a
...
- <DocsLink type="class" parent="Client" symbol="e-threadListSync" />: Emitted whenever the client user gains access to
  a text or news channel that contains threads.
...
Threads are created and deleted using the <DocsLink type="class" parent="GuildTextThreadManager" /> of a text or news channel.
...
To join your client to a thread, use the <DocsLink type="class" parent="ThreadChannel" symbol="join" brackets /> method:
...
And to leave one, use <DocsLink type="class" parent="ThreadChannel" symbol="leave" brackets />;
...
Public threads are viewable by everyone who can view the parent channel of the thread. Public threads can be created with the <DocsLink type="class" parent="GuildTextThreadManager" symbol="create" brackets /> method.
...
To create a private thread, use <DocsLink type="class" parent="GuildTextThreadManager" symbol="create" brackets /> and pass in _`ChannelType.PrivateThread`_ as the _`type`_:
...
To add a member to a thread, use the <DocsLink type="class" parent="ThreadMemberManager" symbol="add" brackets /> method:
...
And to remove a member from a thread, use <DocsLink type="class" parent="ThreadMemberManager" symbol="remove" brackets />:
