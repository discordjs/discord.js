...
<Alert title="Tip" type="info">
	If you would like to set your activity upon startup, you can use the _`ClientOptions`_ object to set the appropriate
	_`Presence`_ data.
</Alert>
...
This can be set as a default in _`ClientOptions`_, and controlled per-message sent by your bot.
