...
<Alert title="Warning" type="warning">
	This will only work if you have the _`GuildMessages`_ and _`MessageContent`_ intent enabled on your client constructor
	and application. If you want to learn more about intents, check out [this dedicated guide on
	intents](/popular-topics/intents.md)!
</Alert>
