...
<Alert title="Tip" type="success">
	This page assumes you have followed the [preparations](preparations) section. If you haven't, please do so before
	continuing. Most of the steps in this page will not work if you haven't completed the preparations.
</Alert>

# Initial files

Once you [add your bot to a server](preparations/adding-your-bot-to-servers.md), the next step is to start coding and get it online! Let's make a config file for your client token, and a main file for your bot application.
