...
<Alert title="@type and @param tags" type="info">
	...
	to annotate your code with type information. The tags are not required for your
	code to run but provide autocomplete and type information for fields and parameters, which can majorly improve your developer experience when working with them.
</Alert>
