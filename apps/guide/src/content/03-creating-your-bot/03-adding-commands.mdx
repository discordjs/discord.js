...
<Alert title="@type and @param tags" type="info">
	...
	[`@param`](https://www.typescriptlang.org/docs/handbook/jsdoc-supported-types.html#param-and-returns) tags are a way
	to annotate type information, we use them here to improve the in-editor experience. They are not required for your
	code to run, but they provide autocomplete and types for fields and parameters which is useful.
</Alert>
