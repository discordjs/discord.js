...
_`fs.readdirSync().filter()`_ returns an array of all the file names in the given directory and filters for only _`.js`_ files, i.e. `['ready.js', 'interactionCreate.js']`.
