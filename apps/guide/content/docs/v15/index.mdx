...
This utility has been removed. Everything in this class is redundant as all methods of the class can be imported from @discord-selfbot-sdk/bot directly.

```js
import { Formatters } from '@discord-selfbot-sdk/bot'; // [!code --]
import { userMention } from '@discord-selfbot-sdk/bot'; // [!code ++]
