...
const { SlashCommandBuilder, PermissionFlagsBits } = require('@discord-selfbot-sdk/bot');
...
```js title="commands/moderation/ban.js"
const { InteractionContextType, PermissionFlagsBits, SlashCommandBuilder } = require('@discord-selfbot-sdk/bot');
