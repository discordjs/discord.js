...
In fact, editing your interaction response is necessary to [calculate the ping](/guide/legacy/popular-topics/faq#how-do-i-check-the-bots-ping) properly for this command.
...
<Callout>
	...
	[FAQ](/popular-topics/faq.md#how-do-i-check-the-bot-s-ping).
</Callout>
...
In addition to the ability to provide [localized command definitions](/guide/legacy/slash-commands/advanced-creation#localizations), you can also localize your responses. To do this, get the locale of the user with `ChatInputCommandInteraction#locale` and respond accordingly:
