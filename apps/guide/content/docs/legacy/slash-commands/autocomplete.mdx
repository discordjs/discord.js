...
<Callout>
	This page is a follow-up to the [slash commands](/guide/legacy/slash-commands/advanced-creation) section covering options and option choices. Please carefully read those pages first so that you can understand the methods used in this section.
</Callout>
...
Or alternatively, by making a small change to your existing [Command handler](/guide/legacy/creating-your-bot/command-handling) and adding an additional method to your individual command files.
...
client.on(Events.InteractionCreate, async (interaction) => {
	if (interaction.isChatInputCommand()) {
		// command handling...
	} else if (interaction.isAutocomplete()) { // [!code ++]
...
<Callout>
	You might have already moved this code to `events/interactionCreate.js` if you followed our [Event handling](/guide/legacy/app-creation/handling-events) guide too.
</Callout>
