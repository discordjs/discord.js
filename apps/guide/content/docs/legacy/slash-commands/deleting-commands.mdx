...
<Callout>
	This page is a follow-up to [command deployment](/guide/legacy/app-creation/deploying-commands). To delete commands, you need to register them in the first place.
</Callout>
