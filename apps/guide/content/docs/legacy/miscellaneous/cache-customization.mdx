...
Sometimes, you would like to be able to customize @discord-selfbot-sdk/bot's caching behavior in order to reduce memory usage.
To this end, @discord-selfbot-sdk/bot provides you with two ways to do so:
...
```js
const { Client, Options } = require('@discord-selfbot-sdk/bot');
