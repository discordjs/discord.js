...
<Callout>
	This is indeed all that a "sync" in Discord categories means! Users and developers alike commonly misunderstand this and expect a proper "sync" state that applies in both directions.
</Callout>
