...
```js
const { TextDisplayBuilder, MessageFlags } = require('@discord-selfbot-sdk/bot');
...
```js
const { SectionBuilder, ButtonStyle, MessageFlags } = require('@discord-selfbot-sdk/bot');
...
```js
const { AttachmentBuilder, SectionBuilder, MessageFlags } = require('@discord-selfbot-sdk/bot');
...
```js
const { AttachmentBuilder, MediaGalleryBuilder, MessageFlags } = require('@discord-selfbot-sdk/bot');
...
```js
const { AttachmentBuilder, FileBuilder, MessageFlags } = require('@discord-selfbot-sdk/bot');
...
const {
	...
	MessageFlags,
} = require('@discord-selfbot-sdk/bot');
...
```js
const { ContainerBuilder, UserSelectMenuBuilder, ButtonStyle, MessageFlags } = require('@discord-selfbot-sdk/bot');
