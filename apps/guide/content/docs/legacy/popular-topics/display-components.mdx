...
While you might be familiar with [embeds](/guide/legacy/popular-topics/embeds) in Discord, there are more ways to style and format your apps messages using **display components**, a comprehensive set of layout and content elements.
...
<Callout type="warn">
    ...
    - All attached files have to explicitly be referenced in a component (refer to the [Thumbnail](/guide/legacy/popular-topics/display-components#thumbnail), [Media Gallery](/guide/legacy/popular-topics/display-components#media-gallery), and [file](/guide/legacy/popular-topics/display-components#file) sections).
...
For more information about using attachments in components refer to the guide on [attaching images in embeds](/guide/legacy/popular-topics/embeds.md#attaching-images).
