...
const { EmbedBuilder } = require('@discord-selfbot-sdk/bot');
...
```js
const { AttachmentBuilder, EmbedBuilder } = require('@discord-selfbot-sdk/bot');
// ...
...
```js
const { AttachmentBuilder } = require('@discord-selfbot-sdk/bot');
// ...
const file = new AttachmentBuilder('../assets/discordjs.png');
