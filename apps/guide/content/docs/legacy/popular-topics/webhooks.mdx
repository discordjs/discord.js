...
Webhooks can send messages to a text channel without having to log in as a bot. They can also fetch, edit, and delete their own messages. There are a variety of methods in @discord-selfbot-sdk/bot to interact with webhooks. In this section, you will learn how to create, fetch, edit, and use webhooks.
...
### Creating webhooks with @discord-selfbot-sdk/bot
...
```js
const { EmbedBuilder, WebhookClient } = require('@discord-selfbot-sdk/bot'); // [!code word:WebhookClient]
...
```js
const { Client, EmbedBuilder, Events, GatewayIntentBits } = require('@discord-selfbot-sdk/bot');
