...
<Callout type="warn">
	Be sure that you're familiar with things like [async/await](/guide/legacy/additional-info/async-await) and [object
	destructuring](/guide/legacy/additional-info/es6-syntax#object-destructuring) before continuing, as we'll be making
	use of those features in the coming sections.
</Callout>
...
<Callout>
	If you followed the [event handler section](/guide/legacy/app-creation/handling-events) of this guide, consider
	putting this into your interaction handler instead!
</Callout>

<Callout type="warn">
	Remember to register the slash commands before continuing on with this section of the guide. You can view how to do
	that [here](/guide/legacy/interactions/slash-commands.md#registering-slash-commands).
</Callout>
