...
<Callout>
	...
	collectors](/guide/legacy/popular-topics/collectors)!
</Callout>
...
<Callout type="error">
	...
	the process whenever it gets killed. You can read our guide on PM2
	[here](/guide/legacy/improving-dev-environment/pm2).
</Callout>
...
<Callout type="warn">
	...
	to learn more about intents, check out [this dedicated guide on intents](/guide/legacy/popular-topics/intents)!
</Callout>
...
<Callout>
	If you're using [sharding](/guide/legacy/sharding/), a specific shard's heartbeat can be found on the WebSocketShard
	instance, accessible at `client.ws.shards.get(id).ping`.
</Callout>
