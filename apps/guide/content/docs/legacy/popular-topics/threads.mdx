...
```js
const { ChannelType, ThreadAutoArchiveDuration } = require('@discord-selfbot-sdk/bot');
...
And that's it! Now you know all there is to know on working with threads using @discord-selfbot-sdk/bot!
