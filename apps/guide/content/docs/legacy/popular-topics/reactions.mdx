...
<Callout>
	...
	async/await](/guide/legacy/additional-info/async-await.md)!
</Callout>
...
<Callout>
	If you use [gateway intents](/guide/legacy/popular-topics/intents) but can't or don't want to use the privileged
	`GuildPresences` intent, you additionally need the `User` partial.
</Callout>
...
<Callout>
	...
	holding the respective structure type might return partials as well! For more info, check out [this
	page](/guide/legacy/popular-topics/partials).
</Callout>
