...
<Callout>
	We're taking advantage of [destructuring](/guide/legacy/additional-info/es6-syntax#destructuring) in this tutorial to
...
<Callout>
	...
	components](/guide/legacy/popular-topics/display-components) section of this guide to learn more about using them!
</Callout>
