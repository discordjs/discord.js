...
<Callout type="warn">
	...
	commands](/guide/legacy/app-creation/handling-commands). It can still serve as an example for using databases in a
	more integrated example. We hope it can help you understand the core idea and apply it to your own use cases!
</Callout>
