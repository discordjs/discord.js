...
<Callout>
    This page is a follow-up to the [slash commands](/guide/legacy/slash-commands/advanced-creation) section. Please carefully read those pages first so that you can understand the methods used in this section.
</Callout>
...
- Responding to context menu commands functions the same as slash commands. Refer to our [slash command responses](/guide/legacy/slash-commands/response-methods) guide for more information.
- Context menu command permissions also function the same as slash commands. Refer to our [slash command permissions](/guide/legacy/slash-commands/permissions) guide for more information.
