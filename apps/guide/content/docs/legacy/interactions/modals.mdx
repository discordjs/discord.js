...
<Callout>
	This page is a follow-up to the [interactions (slash commands) page](/guide/legacy/slash-commands/advanced-creation).
	Please carefully read that section first, so that you can understand the methods used in this section.
</Callout>
