---
title: Installing Node.js and @discord-selfbot-sdk/bot
---
...
To use @discord-selfbot-sdk/bot, you'll need to install the latest LTS version of [Node.js](https://nodejs.org/).
...
To use @discord-selfbot-sdk/bot, you'll need to install it via npm \(Node's package manager\). npm comes with every Node installation, so you don't have to worry about installing that. However, before you install anything, you should set up a new project folder.
...
Once you're done with that, you're ready to install @discord-selfbot-sdk/bot!

## Installing @discord-selfbot-sdk/bot

Now that you've installed Node.js and know how to open your console and run commands, you can finally install @discord-selfbot-sdk/bot! Run the following command in your terminal:
