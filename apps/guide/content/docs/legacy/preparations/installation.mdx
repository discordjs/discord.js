...
import { Grid2x2, Apple, Cpu } from 'lucide-react';
...
<Cards>
	...
	<Card icon={<Apple />} title="macOS">
		- Download the latest version from [the Node.js website](https://nodejs.org/), open the package installer, and
		follow the instructions - Use a package manager like [Homebrew](https://brew.sh/) with the command `brew install
		node`
	</Card>
