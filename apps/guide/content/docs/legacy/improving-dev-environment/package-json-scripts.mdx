...
<Callout>
	We'll assume you have finished the [creating your app](/guide/legacy/app-creation/project-setup) section of the guide.
	If you haven't, ensure to follow it first!
</Callout>
