...
- How to get a bot [up and running](legacy/preparations) from scratch;
- How to properly [create](legacy/creating-your-bot), [organize](legacy/creating-your-bot/command-handling), and expand on your commands;
- In-depth explanations and examples regarding popular topics (e.g. [reactions](legacy/popular-topics/reactions), [embeds](legacy/popular-topics/embeds), [canvas](legacy/popular-topics/canvas));
- Working with databases (e.g. [sequelize](legacy/sequelize/) and [keyv](legacy/keyv/));
