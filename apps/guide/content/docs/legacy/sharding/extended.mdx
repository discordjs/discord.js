...
<Callout type="warn">
	This page is a follow-up and bases its code on [the previous page](/guide/legacy/sharding/additional-information), which assumes knowledge of arguments and passing functions.
</Callout>
...
client.on(Events.InteractionCreate, (interaction) => {
	// ...
	if (commandName === 'send') { // [!code focus:9]
...
client.on(Events.InteractionCreate, (interaction) => {
	// ...
	if (commandName === 'emoji') { // [!code focus:5]
