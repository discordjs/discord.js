...
<Callout type="warn">
	This page is a follow-up and bases its code on [the previous page](/guide/legacy/sharding/additional-information),
	which assumes knowledge of arguments and passing functions.
</Callout>
