...
To begin, you should install Sequelize into your @discord-selfbot-sdk/bot project. We will explain SQlite as the first storage engine and show how to use other databases later. Note that you will need Node 7.6 or above to utilize the `async/await` operators.
...
```sh tab="npm"
npm install @discord-selfbot-sdk/bot sequelize sqlite3
```

```sh tab="yarn"
yarn add @discord-selfbot-sdk/bot sequelize sqlite3
```

```sh tab="pnpm"
pnpm install @discord-selfbot-sdk/bot sequelize sqlite3
```

```sh tab="bun"
bun add @discord-selfbot-sdk/bot sequelize sqlite3
```
...
After you have installed @discord-selfbot-sdk/bot and Sequelize, you can start with the following skeleton code. The comment labels will tell you where to insert code later on.

```js title="sequelize-example.js"
// Require Sequelize
const Sequelize = require('sequelize');
// Require the necessary @discord-selfbot-sdk/bot classes
const { Client, Events, GatewayIntentBits } = require('@discord-selfbot-sdk/bot');
