...
## Using select menus in modals

In modals Text inputs allow free from responses. Select menus allow you to limit user inputs to a preselected list of values
...
![example of string select menu in a modal](./images/modal-select-menu-example.png)
