...
<Callout>
	This page is a follow-up to the [slash commands](/guide/legacy/slash-commands/advanced-creation) section and [action
	rows](/guide/legacy/interactive-components/action-rows) page. Please carefully read those pages first so that you can
	understand the methods used here.
</Callout>
...
<Callout>
	...
	components](/guide/legacy/popular-topics/display-components) if you want to find out more about this.
</Callout>
