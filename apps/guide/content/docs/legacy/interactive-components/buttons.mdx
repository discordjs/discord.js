...
```js
const { ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('@discord-selfbot-sdk/bot');
...
```js
const { ActionRowBuilder, ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('@discord-selfbot-sdk/bot');
