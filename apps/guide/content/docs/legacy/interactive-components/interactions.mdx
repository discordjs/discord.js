...
<Callout>
	This page is a follow-up to the [slash commands](/guide/legacy/slash-commands/advanced-creation) section, and assumes
	you have created either [buttons](/guide/legacy/interactive-components/buttons) or [select
	menus](/guide/legacy/interactive-components/select-menus) as detailed in this guide. Please carefully read those pages
	first so that you can understand the methods used here.
</Callout>
