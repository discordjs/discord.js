...
<Callout>
	This page assumes you've already prepared the [configuration
	files](/guide/legacy/app-creation/project-setup#configuration-files) from the previous page. We're using the
	`config.json` approach, however feel free to substitute your own!
</Callout>
