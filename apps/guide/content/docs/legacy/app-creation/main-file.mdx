...
<Callout>
    This page assumes you've already prepared the [configuration files](/guide/legacy/app-creation/project-setup#configuration-files) from the previous page. We're using the `config.json` approach, however feel free to substitute your own!
</Callout>
...
Intents also define which events Discord should send to your bot, and you may wish to enable more than just the minimum. You can read more about the other intents in the [Intents topic](/guide/legacy/popular-topics/intents).
