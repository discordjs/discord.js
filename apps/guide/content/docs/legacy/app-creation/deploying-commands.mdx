...
The individual command files, containing [slash command](/guide/legacy/app-creation/creating-commands) definitions and functionality.
...
The [command handler](/guide/legacy/app-creation/handling-commands), dynamically reads the command files and executes commands.
...
<Cards>
	<Card title="Event Handling" href="/guide/legacy/app-creation/handling-events">
		Apply a similar dynamic, modular handling approach to client events.
	</Card>
	<Card title="Response Methods" href="/guide/legacy/slash-commands/response-methods">
		Utilize different response methods for slash commands.
	</Card>
	<Card title="Advanced Command Creation" href="/guide/legacy/slash-commands/advanced-creation">
		Expand on the command examples with additional, validated, option types.
	</Card>
	<Card title="Display Components" href="/guide/legacy/popular-topics/display-components">
		Level up command responses with formatted content and display components.
	</Card>
	<Card title="Interactive Components" href="/guide/legacy/popular-topics/interactive-components/action-rows">
