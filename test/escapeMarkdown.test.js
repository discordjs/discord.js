...
describe('escapeInlineQuote', () => {
  test('shared', () => {
    expect(Util.escapeInlineQuote(testString))
      .toBe('\\>`_Behold!_`\n||___~~***```js\n\\>>>`use strict`>;\nrequire(\'discord.js\');```***~~___||');
  });

  test('basic', () => {
    expect(Util.escapeInlineQuote('> test'))
      .toBe('\\> test');
  });

  test('invalid position', () => {
    expect(Util.escapeInlineQuote('test > test'))
      .toBe('test > test');
  });
});
...
describe('escapeBlockQuote', () => {
  test('shared', () => {
    expect(Util.escapeBlockQuote(testString))
      .toBe('>`_Behold!_`\n||___~~***```js\n\\>>>`use strict`>;\nrequire(\'discord.js\');```***~~___||');
  });

  test('basic', () => {
    expect(Util.escapeBlockQuote('>>> test'))
      .toBe('\\>>> test');
  });
...
describe('escapeMarkdown', () => {
  ...
  test('no inline quote', () => {
    expect(Util.escapeMarkdown(testString, { inlineQuote: false }))
      .toBe('>\\`\\_Behold!\\_\\`\n\\|\\|\\_\\_\\_\\~\\~\\*\\*\\*\\`\\`\\`js\n\\>>>\\`use strict\\`>;\nrequire(\'discord.js\');\\`\\`\\`\\*\\*\\*\\~\\~\\_\\_\\_\\|\\|');
  });

  test('no block quote', () => {
    expect(Util.escapeMarkdown(testString, { blockQuote: false }))
      .toBe('\\>\\`\\_Behold!\\_\\`\n\\|\\|\\_\\_\\_\\~\\~\\*\\*\\*\\`\\`\\`js\n\\>>>\\`use strict\\`>;\nrequire(\'discord.js\');\\`\\`\\`\\*\\*\\*\\~\\~\\_\\_\\_\\|\\|');
  });
  ...
  describe('code content', () => {
    ...
    test('no inline code content', () => {
      expect(Util.escapeMarkdown(testString, { inlineCodeContent: false }))
        // TODO(kyranet): The `>` after `use strict` should not be escaped.
        .toBe('\\>\\`_Behold!_\\`\n\\|\\|\\_\\_\\_\\~\\~\\*\\*\\*\\`\\`\\`js\n\\>>>\\`use strict\\`\\>;\nrequire(\'discord.js\');\\`\\`\\`\\*\\*\\*\\~\\~\\_\\_\\_\\|\\|');
    });
