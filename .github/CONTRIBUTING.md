...
pull request. We use Oxlint and Oxfmt to enforce a consistent coding style, so having them set up in your editor of choice
...
5. Run `pnpm run lint` and `pnpm run test` to check formatting, lint the codebase, and run the test suite
