...
module.exports = async (client, { d: data }, shard) => {
  ...
  if (version !== res.tag_name && outdatedwarn === true) console.warn(`Your version is outdated. Consider updating to the newest version using 'npm install discord.js@latest'
