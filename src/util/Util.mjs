 ...
 */
export function splitMessage(text, { maxLength = 1950, char = '\n', prepend = '', append = '' } = {}) {
 ...
 * @returns {string}
 */
export function escapeMarkdown(text, onlyCodeBlock = false, onlyInlineCode = false) {
 ...
 */
export function fetchRecommendedShards(token, guildsPerShard = 1000) {
 ...
 * @private
 */
export function convertToBuffer(ab) {
...
export function setPosition(item, position, relative, sorted, route, reason) {
