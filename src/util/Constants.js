...
exports.requiredChannelPerms = {
  ...
  ADD_REACTIONS        : [FLAGS.VIEW_CHANNEL, FLAGS.ADD_REACTIONS, FLAGS.ADD_REACTIONS],
  SEND_MESSAGES        : [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES],
  SEND_TTS_MESSAGES    : [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.SEND_TTS_MESSAGES],
  MANAGE_MESSAGES      : [FLAGS.VIEW_CHANNEL, FLAGS.MANAGE_MESSAGES],
  EMBED_LINKS          : [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.EMBED_LINKS],
  ATTACH_FILES         : [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.ATTACH_FILES],
  READ_MESSAGE_HISTORY : [FLAGS.VIEW_CHANNEL, FLAGS.READ_MESSAGE_HISTORY],
  MENTION_EVERYONE     : [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.MENTION_EVERYONE],
  ...
  USE_EXTERNAL_EMOJIS  : [FLAGS.VIEW_CHANNEL],
  CONNECT              : [FLAGS.VIEW_CHANNEL, FLAGS.CONNECT],
  SPEAK                : [FLAGS.VIEW_CHANNEL, FLAGS.SPEAK],
  MUTE_MEMBERS         : [FLAGS.VIEW_CHANNEL, FLAGS.MUTE_MEMBERS],
  DEAFEN_MEMBERS       : [FLAGS.VIEW_CHANNEL, FLAGS.DEAFEN_MEMBERS],
  MOVE_MEMBERS         : [FLAGS.VIEW_CHANNEL, FLAGS.MOVE_MEMBERS],
  USE_VAD              : [FLAGS.VIEW_CHANNEL, FLAGS.USE_VAD],
  MANAGE_WEBHOOKS      : [FLAGS.VIEW_CHANNEL, FLAGS.MANAGE_WEBHOOKS],
};

exports.implicitPerms = {
  MANAGE_ROLES: [FLAGS.MANAGE_CHANNELS]
};