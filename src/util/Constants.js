 ...
 * @property {object} [customStructures={}] Custom classes to use instead of included Discord.js classes wherever
 * DataStores create instances (keyed by existing structure name eg: Message, Guild)
