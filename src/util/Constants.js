...
exports.requiredChannelPerms = {
  [FLAGS.CREATE_INSTANT_INVITE]: [FLAGS.VIEW_CHANNEL, FLAGS.CREATE_INSTANT_INVITE],
  [FLAGS.ADD_REACTIONS]: [FLAGS.VIEW_CHANNEL, FLAGS.ADD_REACTIONS, FLAGS.ADD_REACTIONS],
  [FLAGS.SEND_MESSAGES]: [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES],
  [FLAGS.SEND_TTS_MESSAGES]: [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.SEND_TTS_MESSAGES],
  [FLAGS.MANAGE_MESSAGES]: [FLAGS.VIEW_CHANNEL, FLAGS.MANAGE_MESSAGES],
  [FLAGS.EMBED_LINKS]: [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.EMBED_LINKS],
  [FLAGS.ATTACH_FILES]: [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.ATTACH_FILES],
  [FLAGS.READ_MESSAGE_HISTORY]: [FLAGS.VIEW_CHANNEL, FLAGS.READ_MESSAGE_HISTORY],
  [FLAGS.MENTION_EVERYONE]: [FLAGS.VIEW_CHANNEL, FLAGS.SEND_MESSAGES, FLAGS.MENTION_EVERYONE],
  ...
  */
  [FLAGS.USE_EXTERNAL_EMOJIS]: [FLAGS.VIEW_CHANNEL],
  [FLAGS.CONNECT]: [FLAGS.VIEW_CHANNEL, FLAGS.CONNECT],
  [FLAGS.SPEAK]: [FLAGS.VIEW_CHANNEL, FLAGS.SPEAK],
  [FLAGS.MUTE_MEMBERS]: [FLAGS.VIEW_CHANNEL, FLAGS.MUTE_MEMBERS],
  [FLAGS.DEAFEN_MEMBERS]: [FLAGS.VIEW_CHANNEL, FLAGS.DEAFEN_MEMBERS],
  [FLAGS.MOVE_MEMBERS]: [FLAGS.VIEW_CHANNEL, FLAGS.MOVE_MEMBERS],
  [FLAGS.USE_VAD]: [FLAGS.VIEW_CHANNEL, FLAGS.USE_VAD],
  [FLAGS.MANAGE_WEBHOOKS]: [FLAGS.VIEW_CHANNEL, FLAGS.MANAGE_WEBHOOKS],
};
...
exports.implicitPerms = {
  [FLAGS.MANAGE_CHANNELS]: FLAGS.MANAGE_ROLES,
  [FLAGS.CHANGE_NICKNAME]: FLAGS.MANAGE_NICKNAMES,
};
