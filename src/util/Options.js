 ...
 * @property {number} [fetchGuildTimeout=15000] Time in milliseconds that Clients with the GUILDS intent should hang and wait for missing guilds to be recieved before starting. Default is 15 seconds.
