 ...
 * @property {number} [fetchGuildTimeout=15000] Time in milliseconds that Clients with the GUILDS intent should hang and wait for missing guilds to be recieved before starting the bot. If not specified, the default is 15 seconds.
