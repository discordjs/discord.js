...
var Server = (function (_Equality) {
	...
	Server.prototype.updateRole = function updateRole() {
		return this.client.updateRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.deleteRole = function deleteRole() {
		return this.client.deleteRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.memberHasRole = function memberHasRole() {
		return this.client.memberHasRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.memberHas = function memberHas() {
		return this.client.memberHasRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.addMemberToRole = function addMemberToRole() {
		return this.client.addMemberToRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.addUserToRole = function addUserToRole() {
		return this.client.addMemberToRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};

	Server.prototype.removeMemberFromRole = function removeMemberFromRole() {
		return this.client.removeMemberFromRole.apply(this.client, _UtilArgumentRegulariser.reg(this, arguments));
	};
