...
var User = (function (_Equality) {
	...
	User.prototype.equalsStrict = function equalsStrict(obj) {
		if (obj instanceof User) return this.id === obj.id && this.username === obj.username && this.discriminator === obj.discriminator && this.avatar === obj.avatar && this.status === obj.status && this.game === obj.game;else return false;
	};
