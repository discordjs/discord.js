...
var WEBHOOK = Constants.WEBHOOK = "https://canary.discordapp.com/api/webhooks";
...
var Endpoints = Constants.Endpoints = {
	...
	WEBHOOK: function WEBHOOK(webhookID) {
		return Endpoints.WEBHOOKS + "/webhook-object";
	},
	WEBHOOK_WITH_TOKEN: function WEBHOOK_WITH_TOKEN(webhookID, webhookToken) {
		return Endpoints.WEBHOOKS + "/" + webhookToken + "/webhook-object";
	},
