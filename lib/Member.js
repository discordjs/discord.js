...
var Member = (function (_User) {
	...
	Member.prototype.permissionsIn = function permissionsIn(channel) {
		...
		for (var _iterator2 = channel.roles, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
			...
			if (overwrite.id == this.serverID) {
				// @everyone for channel
				affectingOverwrites.push(overwrite);
				break;
			}
		}

		for (var _iterator3 = channel.roles, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
			var _ref3;
	...
	_createClass(Member, [{
		...
		get: function get() {
			...
			for (var _iterator6 = this.rawRoles, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
				var _ref6;
		...
		get: function get() {
			...
			basePerms = basePerms || [];
			for (var _iterator7 = basePerms, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
				var _ref7;
