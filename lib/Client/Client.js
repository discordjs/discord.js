 ...
 */
	...
	sendMessage(where, content, options = {}, callback = function (e, m) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.sendMessage(where, content, options).then(m => {
				callback(null, m);
				resolve(m);
			}).catch(e => {
				callback(e);
	...
	sendTTSMessage(where, content, callback = function (e, m) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.sendMessage(where, content, { tts: true }).then(m => {
				callback(null, m);
				resolve(m);
			}).catch(e => {
				callback(e);
	...
	reply(where, content, options = {}, callback = function (e, m) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			if (msg) {
				...
				self.internal.sendMessage(msg, content, options).then(m => {
					callback(null, m);
					resolve(m);
				}).catch(e => {
					callback(e);
	...
	replyTTS(where, content, callback = function () {}) {
		return new Promise((resolve, reject) => {
			self.reply(where, content, { tts: true }).then(m => {
				callback(null, m);
				resolve(m);
			}).catch(e => {
				callback(e);
	...
	deleteMessage(msg, options = {}, callback = function (e) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.deleteMessage(msg, options).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	updateMessage(msg, content, options = {}, callback = function (err, msg) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.updateMessage(msg, content, options).then(msg => {
				callback(null, msg);
				resolve(msg);
			}).catch(e => {
				callback(e);
	...
	getChannelLogs(where, limit = 500, options = {}, callback = function (err, logs) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.getChannelLogs(where, limit, options).then(logs => {
				callback(null, logs);
				resolve(logs);
			}).catch(e => {
				callback(e);
	...
	getBans(where, callback = function (err, bans) {}) {
		...
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.getBans(where).then(bans => {
				callback(null, bans);
				resolve(bans);
			}).catch(e => {
				callback(e);
	...
	sendFile(where, attachment, name = "image.png", callback = function (err, m) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.sendFile(where, attachment, name).then(m => {
				callback(null, m);
				resolve(m);
			}).catch(e => {
				callback(e);
	...
	joinServer(invite, callback = function (err, srv) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.joinServer(invite).then(srv => {
				callback(null, srv);
				resolve(srv);
			}).catch(e => {
				callback(e);
	...
	createServer(name, region = "london", callback = function (err, srv) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.createServer(name, region).then(srv => {
				callback(null, srv);
				resolve(srv);
			}).catch(e => {
				callback(e);
	...
	leaveServer(server, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.leaveServer(server).then(() => {
				callback();resolve();
			}).catch(e => {
				callback(e);reject(e);
			});
	...
	createChannel(server, name, type = "text", callback = function (err, channel) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.createChannel(server, name, type).then(channel => {
	...
	deleteChannel(channel, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.deleteChannel(channel).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);reject(e);
	...
	banMember(user, server, length = 1, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.banMember(user, server, length).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);reject(e);
	...
	unbanMember(user, server, callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.unbanMember(user, server).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);reject(e);
	...
	kickMember(user, server, callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.kickMember(user, server).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);reject(e);
	...
	createRole(server, data = null, callback = function (err, res) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.createRole(server, data).then(role => {
				callback(null, role);
				resolve(role);
			}).catch(e => {
				callback(e);
	...
	updateRole(role, data = null, callback = function (err, res) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.updateRole(role, data).then(role => {
				callback(null, role);
				resolve(role);
			}).catch(e => {
				callback(e);
	...
	deleteRole(role, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.deleteRole(role).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	addMemberToRole(member, role, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.addMemberToRole(member, role).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	removeMemberFromRole(member, role, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.removeMemberFromRole(member, role).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	createInvite(chanServ, options, callback = function (err, invite) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.createInvite(chanServ, options).then(invite => {
	...
	deleteInvite(invite, callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.deleteInvite(invite).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	overwritePermissions(channel, role, options = {}, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.overwritePermissions(channel, role, options).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	setStatus(idleStatus, gameID, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.setStatus(idleStatus, gameID).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	sendTyping(channel, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.sendTyping(channel).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	setTopic(channel, topic, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.setTopic(channel, topic).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	setChannelName(channel, name, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.setChannelName(channel, name).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	setChannelNameAndTopic(channel, name, topic, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.setChannelNameAndTopic(channel, name, topic).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	updateChannel(channel, data, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.updateChannel(channel, data).then(() => {
				callback();
				resolve();
			}).catch(e => {
				callback(e);
	...
	startTyping(channel, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.startTyping(channel).then(() => {
				callback(null);
				resolve();
			}).catch(e => {
				callback(e);
	...
	stopTyping(channel, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.stopTyping(channel).then(() => {
				callback(null);
				resolve();
			}).catch(e => {
				callback(e);
	...
	updateDetails(details, callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.updateDetails(details).then(() => {
				callback();
				resolve();
			}).catch(err => {
				callback(err);
	...
	setUsername(name, callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.setUsername(name).then(() => {
				callback();
				resolve();
			}).catch(err => {
				callback(err);
	...
	joinVoiceChannel(channel, callback = function (err) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			self.internal.joinVoiceChannel(channel).then(chan => {
				callback(null, chan);
				resolve(chan);
			}).catch(err => {
				callback(err);
	...
	leaveVoiceChannel(callback = function (err) {}) {
		var self = this;
		return new Promise((resolve, reject) => {
			self.internal.leaveVoiceChannel().then(() => {
				callback();
				resolve();
			}).catch(err => {
				callback(err);
	...
	awaitResponse(msg, toSend = null, options = null, callback = function (e, newMsg) {}) {
		...
		return new Promise((resolve, reject) => {
			...
			function final() {
				self.internal.awaitResponse(msg).then(newMsg => {
					resolve(newMsg);
