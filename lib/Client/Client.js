...
var Client = (function (_EventEmitter) {
  ...
  */
	...
	Client.prototype.login = function login(email, password) {
		var tfaCode = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
		var callback = arguments.length <= 3 || arguments[3] === undefined ? function () /*err, token*/{} : arguments[3];
		...
		return this.internal.login(email, password, tfaCode).then(dataCallback(callback), errorCallback(callback));
	};
