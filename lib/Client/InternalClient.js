			...
			switch (packet.t) {
				...
				case _Constants.PacketType.SERVER_MEMBERS_CHUNK:
					...
					if (server) {
						...
						if (_this39.forceFetchCount.hasOwnProperty(guild.id)) {
							if (_this39.forceFetchCount[guild.id] <= 1) {
								delete _this39.forceFetchCount[guild.id];
								_this39.checkReady();
							} else {
								_this39.forceFetchCount[guild.id]--;
							}
						}
