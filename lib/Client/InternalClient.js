...
var InternalClient = (function () {
	...
	InternalClient.prototype.getGuildMembers = function getGuildMembers(guildID, chunkCount) {
		this.forceFetchCount[guildID] = chunkCount;
		if (this.forceFetchLength + 3 + guildID.length > 4082) {
	...
	InternalClient.prototype.requestGuildMembers = function requestGuildMembers(guildID, query, limit) {
