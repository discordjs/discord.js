  ...
  */
		...
		return new Promise(function (resolve, reject) {
			...
			request.get(Endpoints.SERVERS + "/" + serverID + "/bans").set("authorization", self.token).end(function (err, res) {
				...
				if (err) {
					...
					for (var _iterator5 = res.body, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
						var _ref5;
		...
		this.websocket.onmessage = function (e) {
			...
			switch (dat.t) {
				...
				case "READY":
					...
					for (var _iterator6 = data.guilds, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
						var _ref6;
					...
					for (var _iterator7 = data.private_channels, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
						var _ref7;
	...
	Client.prototype.addServer = function addServer(data) {
		...
		if (!server || force) {
			...
			if (data.channels) {
				for (var _iterator10 = data.channels, _isArray10 = Array.isArray(_iterator10), _i10 = 0, _iterator10 = _isArray10 ? _iterator10 : _iterator10[Symbol.iterator]();;) {
					var _ref10;
	...
	Client.prototype.getUser = function getUser(key, value) {
		for (var _iterator12 = this.userCache, _isArray12 = Array.isArray(_iterator12), _i12 = 0, _iterator12 = _isArray12 ? _iterator12 : _iterator12[Symbol.iterator]();;) {
			var _ref12;
	...
	Client.prototype.getChannel = function getChannel(key, value) {
		for (var _iterator13 = this.channelCache, _isArray13 = Array.isArray(_iterator13), _i13 = 0, _iterator13 = _isArray13 ? _iterator13 : _iterator13[Symbol.iterator]();;) {
			var _ref13;
	...
	Client.prototype.getPMChannel = function getPMChannel(key, value) {
		for (var _iterator14 = this.pmChannelCache, _isArray14 = Array.isArray(_iterator14), _i14 = 0, _iterator14 = _isArray14 ? _iterator14 : _iterator14[Symbol.iterator]();;) {
			var _ref14;
	...
	Client.prototype.getServer = function getServer(key, value) {
		for (var _iterator15 = this.serverCache, _isArray15 = Array.isArray(_iterator15), _i15 = 0, _iterator15 = _isArray15 ? _iterator15 : _iterator15[Symbol.iterator]();;) {
			var _ref15;
		...
		return new Promise(function (resolve, reject) {
			if (destination instanceof Server) {
				channId = destination.id; //general is the same as server id
					...
					for (var _iterator16 = self.pmChannelCache, _isArray16 = Array.isArray(_iterator16), _i16 = 0, _iterator16 = _isArray16 ? _iterator16 : _iterator16[Symbol.iterator]();;) {
						var _ref16;
		...
		return new Promise(function (resolve, reject) {
			request.post(Endpoints.CHANNELS + "/" + destination + "/messages").set("authorization", self.token).send({
				...
				if (err) {
					...
					for (var _iterator17 = data.mentions, _isArray17 = Array.isArray(_iterator17), _i17 = 0, _iterator17 = _isArray17 ? _iterator17 : _iterator17[Symbol.iterator]();;) {
						var _ref17;
	...
	Client.prototype.setPlayingGame = function setPlayingGame(id) {
		...
		if (id instanceof String || typeof id === "string") {
			...
			for (var _iterator18 = gameMap, _isArray18 = Array.isArray(_iterator18), _i18 = 0, _iterator18 = _isArray18 ? _iterator18 : _iterator18[Symbol.iterator]();;) {
				var _ref18;
