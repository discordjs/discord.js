  ...
  */
		...
		return new Promise(function (resolve, reject) {
			...
			request.get(Endpoints.CHANNELS + "/" + channelID + "/messages?limit=" + amount + joinedParams).set("authorization", self.token).end(function (err, res) {
				...
				if (err) {
					...
					for (var _iterator2 = res.body, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
						var _ref2;
						...
						var mentions = [];
						for (var _iterator3 = message.mentions, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
							var _ref3;
	...
	Client.prototype.sendMessage = function sendMessage(destination, message, options) {
		...
		var prom = new Promise(function (resolve, reject) {
			...
			function resolveMentions() {
				var _mentions = [];
				for (var _iterator4 = message.match(/<@[^>]*>/g) || [], _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
					var _ref4;
	...
	Client.prototype.createRoleIfNotExists = function createRoleIfNotExists(dest, data) {
		...
		return new Promise(function (resolve, reject) {
			...
			for (var _iterator5 = server.roles, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
				var _ref5;
		...
		return new Promise(function (resolve, reject) {
			...
			request.post(Endpoints.SERVERS + "/" + ddest + "/roles").set("authorization", self.token).end(function (err, res) {
				...
				if (err) {
					...
					if (data && data.color) data.color = Color.toDec(data.color);
	...
	Client.prototype.getBans = function getBans(serverResource) {
		var callback = arguments.length <= 1 || arguments[1] === undefined ? function (err, arrayOfBans) {} : arguments[1];
		...
		return new Promise(function (resolve, reject) {
			...
			request.get(Endpoints.SERVERS + "/" + serverID + "/bans").set("authorization", self.token).end(function (err, res) {
				...
				if (err) {
					...
					for (var _iterator6 = res.body, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
						var _ref6;
		...
		this.websocket.onmessage = function (e) {
			...
			switch (dat.t) {
				...
				case "READY":
					...
					for (var _iterator7 = data.guilds, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
						var _ref7;
					...
					for (var _iterator8 = data.private_channels, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();;) {
						var _ref8;
				...
				case "MESSAGE_CREATE":
					...
					for (var _iterator9 = data.mentions, _isArray9 = Array.isArray(_iterator9), _i9 = 0, _iterator9 = _isArray9 ? _iterator9 : _iterator9[Symbol.iterator]();;) {
						var _ref9;
				...
				case "MESSAGE_UPDATE":
					...
					if (formerMessage) {
						...
						for (var _iterator10 = data.mentions, _isArray10 = Array.isArray(_iterator10), _i10 = 0, _iterator10 = _isArray10 ? _iterator10 : _iterator10[Symbol.iterator]();;) {
							var _ref10;
				...
				case "GUILD_DELETE":
					...
					if (server) {
						for (var _iterator11 = server.channels, _isArray11 = Array.isArray(_iterator11), _i11 = 0, _iterator11 = _isArray11 ? _iterator11 : _iterator11[Symbol.iterator]();;) {
							var _ref11;
	...
	Client.prototype.addServer = function addServer(data) {
		...
		if (!server || force) {
			...
			if (data.channels) {
				for (var _iterator12 = data.channels, _isArray12 = Array.isArray(_iterator12), _i12 = 0, _iterator12 = _isArray12 ? _iterator12 : _iterator12[Symbol.iterator]();;) {
					var _ref12;
			...
			if (data.presences) {
				for (var _iterator13 = data.presences, _isArray13 = Array.isArray(_iterator13), _i13 = 0, _iterator13 = _isArray13 ? _iterator13 : _iterator13[Symbol.iterator]();;) {
					var _ref13;
	...
	Client.prototype.getUser = function getUser(key, value) {
		for (var _iterator14 = this.userCache, _isArray14 = Array.isArray(_iterator14), _i14 = 0, _iterator14 = _isArray14 ? _iterator14 : _iterator14[Symbol.iterator]();;) {
			var _ref14;
	...
	Client.prototype.getChannel = function getChannel(key, value) {
		for (var _iterator15 = this.channelCache, _isArray15 = Array.isArray(_iterator15), _i15 = 0, _iterator15 = _isArray15 ? _iterator15 : _iterator15[Symbol.iterator]();;) {
			var _ref15;
	...
	Client.prototype.getPMChannel = function getPMChannel(key, value) {
		for (var _iterator16 = this.pmChannelCache, _isArray16 = Array.isArray(_iterator16), _i16 = 0, _iterator16 = _isArray16 ? _iterator16 : _iterator16[Symbol.iterator]();;) {
			var _ref16;
	...
	Client.prototype.getServer = function getServer(key, value) {
		for (var _iterator17 = this.serverCache, _isArray17 = Array.isArray(_iterator17), _i17 = 0, _iterator17 = _isArray17 ? _iterator17 : _iterator17[Symbol.iterator]();;) {
			var _ref17;
		...
		return new Promise(function (resolve, reject) {
			if (destination instanceof Server) {
				channId = destination.id; //general is the same as server id
					...
					for (var _iterator18 = self.pmChannelCache, _isArray18 = Array.isArray(_iterator18), _i18 = 0, _iterator18 = _isArray18 ? _iterator18 : _iterator18[Symbol.iterator]();;) {
						var _ref18;
		...
		return new Promise(function (resolve, reject) {
			...
			request.post(Endpoints.CHANNELS + "/" + destination + "/messages").set("authorization", self.token).send({
				...
				if (err) {
					...
					for (var _iterator19 = data.mentions, _isArray19 = Array.isArray(_iterator19), _i19 = 0, _iterator19 = _isArray19 ? _iterator19 : _iterator19[Symbol.iterator]();;) {
						var _ref19;
	...
	Client.prototype.setPlayingGame = function setPlayingGame(id) {
		...
		if (id instanceof String || typeof id === "string") {
			...
			for (var _iterator20 = gameMap, _isArray20 = Array.isArray(_iterator20), _i20 = 0, _iterator20 = _isArray20 ? _iterator20 : _iterator20[Symbol.iterator]();;) {
				var _ref20;
	...
	Client.prototype.resolveInvite = function resolveInvite(resource) {
			...
			rstate.forEach(function (catchup, index) {
				if (self.options.catchup === "all") {
					self.getChannelLogs(catchup.id, 100000, {
						...
						for (var _iterator21 = results, _isArray21 = Array.isArray(_iterator21), _i21 = 0, _iterator21 = _isArray21 ? _iterator21 : _iterator21[Symbol.iterator]();;) {
							var _ref21;
					...
					self.getChannelLogs(catchup.id, 2500).then(function (results) {
						...
						for (var _iterator22 = results, _isArray22 = Array.isArray(_iterator22), _i22 = 0, _iterator22 = _isArray22 ? _iterator22 : _iterator22[Symbol.iterator]();;) {
							var _ref22;
	...
	_createClass(Client, [{
		...
		get: function get() {
			...
			var msgs = [];
			for (var _iterator23 = this.channelCache, _isArray23 = Array.isArray(_iterator23), _i23 = 0, _iterator23 = _isArray23 ? _iterator23 : _iterator23[Symbol.iterator]();;) {
				var _ref23;
