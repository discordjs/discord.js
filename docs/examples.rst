...
You can also use a `Message`_ as an parameter. This example sends "Hello" to the channel the message was sent from.
...
You can send DMs to a user with a `User`_. This will send "Hello" as an DM to the author of the received message.
